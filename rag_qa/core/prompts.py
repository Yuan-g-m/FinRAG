...
class RAGPrompts:
    ...
    def rag_prompt():
        ...
        return PromptTemplate(
            template="""  
                你是 FinRAG 金融智能助手，帮助用户解答金融领域问题。请参考对话历史和检索到的上下文回答问题。
                如果提供了上下文，请基于上下文回答；如果没有上下文，请直接根据你的金融知识回答。  
                如果答案来源于检索到的文档，请在回答中说明。
                涉及投资建议、收益预测或风险判断时，请提示“仅供参考，不构成投资建议”。
...
if __name__ == '__main__':
    ...
    # 2. 测试RAG基础模板.
    result = rag_prompt.format(context="股票是一种有价证券，代表对股份有限公司的所有权凭证。", history="", question="股票的定义是什么？", phone="400-800-8899")
    # 3. 打印结果
    print(result)
    print('♥️' * 30)
    ...
    # 2. 测试HyDE模板.
    result = hyde_prompt.format(query="央行降息对债券市场有什么影响")
    # 3. 打印结果
    print(result)
